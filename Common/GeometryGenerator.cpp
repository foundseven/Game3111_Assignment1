...
{
	return CreateCylinder(bottomRad, 0, height, sliceCount, stackCount);
}
GeometryGenerator::MeshData GeometryGenerator::CreatePyramid(float bottomRad, float height, uint32 stackCount)
{
	return CreateCylinder(bottomRad, 0, height, 4, stackCount);
}
